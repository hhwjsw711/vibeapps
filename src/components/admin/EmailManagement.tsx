...
const EMAIL_TYPE_GROUPS: Array<{
  ...
  },
  {
    ...
    types: [
      {
        key: "judging_group",
        label: "Judging group emails",
        description:
          "Lets organizers with access send template emails to a group's judges",
      },
    ],
  },
];
...
export function EmailManagement() {
  // Sub tabs: everything that existed before lives under "send";
  // "templates" hosts the reusable email template manager.
  const [activeSubTab, setActiveSubTab] = useState<"send" | "templates">(
    "send",
  );
  ...
  return (
    <>
      ...
      <div className="space-y-8">
        ...
        {activeSubTab === "templates" && <EmailTemplatesManager />}
            ...
            <div className="bg-surface rounded-lg p-6 border border-hairline">
              ...
              {emailsEnabled === false && (
                <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-md text-sm">
                  The global email system is off, so none of these types will
                  send. Toggle states are preserved and take effect when the
                ...
                <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-md">
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded mb-3">
                    ...
                    <p className="text-sm text-blue-800 mb-2">
                      <strong>For users without emails:</strong> They need to
                      log out and log back in to sync their email addresses from
                      Clerk.
                    </p>
                    <p className="text-xs text-blue-700">
                      The email system is now working correctly and will
                      automatically sync emails when users authenticate.
                    </p>
                  </div>
                          ...
                          async () => {
                            try {
                              const result = await forceLogoutAllMutation({
                                reason:
                                  "Email sync - admin forced re-authentication",
                              });
                              showMessage(
                                result.success ? "Success" : "Error",
                                result.message,
                          ...
                          async () => {
                            try {
                              ...
                              showMessage(
                                ...
                                error instanceof Error
                                  ? error.message
                                  : "Failed to send daily user emails",
                                "error",
                              );
                            }
                          },
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    Sent daily at 9:00 AM PST with platform metrics when enabled
                    in Email Send Options
                  </p>
                </div>
                <div className="p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-sm text-green-700">
                    Daily digest emails with mentions and activity when enabled
                    in Email Send Options
                  </p>
                </div>
                <div className="p-4 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-sm text-purple-700">
                    Monday morning "Most Vibes" weekly roundup when enabled in
                    Email Send Options
                  </p>
                </div>
              </div>
            ...
            <div className="bg-surface rounded-lg p-6 border border-hairline">
              ...
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="text-sm text-yellow-800 space-y-1">
                  ...
                  <p>
                    • <strong>Mention Notifications:</strong> Included in daily
                    digest emails (max 10 per email)
                  </p>
                  <p>
                    • <strong>Unsubscribe:</strong> Users can opt out via
                    profile settings
                  </p>
                </div>
              </div>
