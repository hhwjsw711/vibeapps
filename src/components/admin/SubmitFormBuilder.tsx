            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="p-3 bg-surface-alt rounded-md border">
        ...
        return (
          <div className="bg-canvas rounded-lg border border-hairline p-6">
            <div className="space-y-6">
              ...
              {/* Form Preview */}
              <div className="border-2 border-dashed border-hairline-strong rounded-lg p-8">
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="text-center mb-8">
                    ...
                    {formWithFields.headerText && (
                      <p className="text-copy whitespace-pre-line">
                        {formWithFields.headerText}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-6">
                          ...
                          <div key={field._id} className="space-y-2">
                            ...
                            {field.key === "longDescription" ? (
                              <textarea
                                ...
                                className="w-full px-3 py-2 border border-hairline-strong rounded-md bg-surface-alt"
                                rows={4}
                                disabled
                              />
                            ) : (
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        type="file"
                        accept="image/*"
                        className="w-full px-3 py-2 border border-hairline-strong rounded-md bg-surface-alt file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-surface-alt file:text-copy"
                        disabled
                      />
                    </div>
                    ...
                    <div className="pt-6">
                      <button
                        type="button"
                        className="w-full bg-cta text-on-cta py-3 px-6 rounded-lg font-medium bg-surface-alt cursor-not-allowed"
                        disabled
                      >
                        {formWithFields.submitButtonText || "Submit App"}
                      </button>
              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                  activeTab === tab.id
                    ...
                    : "border-transparent text-soft hover:text-copy hover:border-hairline-strong"
                }`}
              >
