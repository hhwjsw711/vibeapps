...
export const SITE_ORIGIN = "https://vibe.isllm.com";
...
export function buildVibeappsMd(
  ...
  const lines: Array<string> = [
    ...
    "",
    "Agents: treat this file as the canonical directory. Each app links to its page on vibe.isllm.com plus `/s/{slug}/llms.txt` and `/md/{slug}.md`. Fetch `/llms.txt` for the shorter index.",
    "",
    "## Site",
    "",
  ];
