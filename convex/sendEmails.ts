...
const SAMPLE_FROM = "VibeApps Updates <alerts@updates.vibe.isllm.com>";
  ...
  const samples: Array<{ key: string; subject: string; html: string }> = [
    {
      ...
      html: templateEmailShell(
        `<h1 style="color: #292929; margin-bottom: 10px;">Submission received</h1>
            ...
            <p style="color: #666; margin-bottom: 20px;">
              View it here:
              <a href="https://vibe.isllm.com/s/sample-app" style="color: #292929;">https://vibe.isllm.com/s/sample-app</a>
            </p>`,
        undefined,
        footerOpts,
      ),
      ...
      html: templateEmailShell(
        `<h1 style="color: #292929; margin-bottom: 10px;">New submission in Sample Hackathon</h1>
            ...
            <p style="color: #666; margin-bottom: 20px;">
              ...
              <a href="https://vibe.isllm.com/admin/judging/sample-hackathon?section=submissions" style="color: #292929;">Open submissions</a>
            </p>`,
        undefined,
        footerOpts,
      ),
